...
Backbone of the Prometeus Network is our  fork for the Golang implementation of the Ethereum protocol. It was created essentially to avoid the block difficulty growth to allow faster transactions in our network.
